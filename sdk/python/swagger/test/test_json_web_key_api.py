...
from swagger_client.apis.json_web_key_api import JsonWebKeyApi


class TestJsonWebKeyApi(unittest.TestCase):
    """ JsonWebKeyApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.json_web_key_api.JsonWebKeyApi()
