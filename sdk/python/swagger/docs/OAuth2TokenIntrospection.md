...
**aud** | **str** | ClientID is a service-specific string identifier or list of string identifiers representing the intended audience for this token. | [optional] 
**client_id** | **str** | ClientID is aclient identifier for the OAuth 2.0 client that requested this token. | [optional] 
...
**iss** | **str** | Issuer is a string representing the issuer of this token | [optional] 
